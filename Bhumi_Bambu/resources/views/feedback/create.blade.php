    ...
    <div class="form-wrapper">
      ...
      <div class="form-header">
        ...
        <div class="header-text">
          <h2>Tulis Feedback Baru</h2>
          <p>Ulasan Anda sangat berarti bagi pengembangan kualitas layanan di Bhumi Bambu</p>
        </div>
      </div>
      ...
      <div class="form-card-container">
        ...
        <form action="{{ route('feedback.store') }}" method="POST" class="native-form">
          @csrf

          <div class="form-group">
            <label for="judul" class="form-label">Judul Ulasan <span class="required">*</span></label>
            <input type="text" id="judul" name="judul" value="{{ old('judul') }}" class="form-input" placeholder="Contoh: Pengalaman Berkemah yang Berkesan" required>
          ...
          <div class="form-group">
            ...
            <textarea id="komentar" name="komentar" rows="6" class="form-textarea" placeholder="Tuliskan pengalaman Anda secara jujur selama berada di Bhumi Bambu Baturraden..." required>{{ old('komentar') }}</textarea>
          ...
          <div class="form-footer-actions">
            <a href="{{ route('feedback.index') }}" class="form-btn-cancel">Batal</a>
